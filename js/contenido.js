// Función para agregar un nuevo párrafo con el texto del textarea
...
// Manejador de eventos para el input de archivo para mostrar la imagen seleccionada
...
// Función para imprimir el contenido del div 'contenido'
function imprimir() {
